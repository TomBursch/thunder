...
class FeedPage extends StatefulWidget {
  ...
  const FeedPage({super.key, this.listingType});
...
class _FeedPageState extends State<FeedPage>
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<CommunityBloc>(
      create: (context) => CommunityBloc(widget.listingType),
                    ...
                    actions: [
                      ...
                      IconButton(
                          ...
                          onPressed: () {
                            ...
                            return context
                                .read<CommunityBloc>()
                                .add(const GetCommunityPostsEvent(reset: true));
                          }),
                      IconButton(
  ...
  Widget _getBody(BuildContext context, CommunityState state) {
    switch (state.status) {
      case CommunityStatus.initial:
        ...
        context.read<CommunityBloc>().add(GetCommunityPostsEvent(reset: true));
